...
st.markdown('### Design IIR High pass filter using Butterworth filter')
fp=st.text_input('Enter the pass band freq ',placeholder="3000")
fs=st.text_input('Enter the stop band freq ',placeholder="1500")
